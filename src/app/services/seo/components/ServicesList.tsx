...
const services = [
  {
    title: 'Our SEO Toolkit',
    description: 'SEO is a broader aspect, more than keyword planning and writing SEO-friendly content. This is how we work on SEO to rank your website higher: ',
    features: [
      'Keyword Research and Strategy', 'On-Page SEO', 'Off-Page SEO',
      'Technical SEO', 'Local SEO', 'Monitoring and Analysis'
    ]
  },
];
