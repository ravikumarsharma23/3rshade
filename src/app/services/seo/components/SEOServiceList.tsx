...
const services = [
  {
    title: 'Uncover the Truth: Do not fall for these Myths about SEO',
    description: 'SEO is not a one-day job, it is a work in progress always. If you think SEO is just about keywords we are here to break some myths.',
    features: [
      'More keywords, better the rank', 'Keywords matter, not the content', 'Title and Meta Tags are not so important',
      'You only have to do SEO once', 'You can do SEO on your Own', 'SEO results can be seen overnight'
    ]
  },
];

const SEOServicesList: React.FC = () => {
