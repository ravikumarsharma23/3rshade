      ...
      >
        ...
        >
          <motion.h2 
            ...
            variants={itemVariants}
          >
           The Blueprint for a Powerful Branding
          </motion.h2>
        </motion.div>
          ...
          {[
            {
              ...
              description: 'We delve deep to understand your business goals, brand,  its unique value proposition.'
            },
            {
              title: 'Research',
              description: 'We analyze your target audience, market trends, and competitors to position your brand strategically.'
            },
            {
              title: 'Ideation',
              description: 'Our creative team brainstorms unique concepts, crafting initial designs, taglines, and brand stories.'
            }
          ].map((benefit, index) => (
            <motion.div 
              key={index} 
