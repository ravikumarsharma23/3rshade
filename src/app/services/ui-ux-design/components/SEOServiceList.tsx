...
const services = [
  {
    title: 'Breaking Popular Misconceptions About UI/UX Design',
    description: 'UI/UX is more than just aesthetics—it’s about crafting seamless, engaging experiences that resonate with users.',
    features: [
      'More visuals mean better design', 'UI and UX are the same', 'No need for research',
      '⁠It’s a one-time task', 'Only big brands need UI/UX', 'Design can be done without user testing'
    ]
  },
];
