...
const services = [
  {
    title: 'A Good UI/UX will make your brand',
    description: 'A product that looks good and is easy to use, steals the show. This is exactly what UI/UX does to your brand, be it web or iOS. A killer UI catches attention; a seamless UX keeps it.',
    features: [
      'Improves User Engagement', 'Higher Conversion Rate', 'Builds Brand Credibility and Trust',
      'Cost Efficient', 'Retains Users '
    ]
  },
];
