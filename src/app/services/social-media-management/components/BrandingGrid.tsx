...
const services = [
  {
    title: 'Social Media: Your Social ‘Spotlight’',
    description: 'Here brands become friends and customers become fans. From instant client feedback to global reach, it empowers businesses to connect, engage, and thrive in a hyper-connected world.',
    features: [
      'Increases brand awareness', 'Builds strong relationships with customers','Improves Online Visibility','Tracks Audience Insights','Builds a Loyal Following','Enhances Brand Image',
    ]
  },
];
