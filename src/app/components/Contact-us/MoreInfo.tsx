  ...
  return (
    <>
      ...
      `}>
        ...
        `}>
        Let's Talk - Free Strategy Session
    </h2>
        <button
          onClick={() => router.push('/register')}
          className={`
            ${theme === 'dark' 
              ? 'bg-black text-white hover:shadow-[0_0_10px_3px_rgba(255,255,255,0.6)]' 
              : 'bg-white text-black hover:shadow-[0_0_10px_3px_rgba(0,255,255,0.6)]'
            }
